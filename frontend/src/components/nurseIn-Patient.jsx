...
import chimeSound from '/public/chime.mp3'
                    ...
                    <div className="grid-cell patient-info-cell">
                        <div className="info">
                            ...
                            <div className="patient-details-text">
                                ...
                                <p>Allergies:  {patient.allergies && patient.allergies.length > 0 
                        ...
                        <b>{patient.room}</b>
                            ...
                            <div className={`icon-wrapper prn-icon  ${activePRNs[patient.name] ? 'active' : 'inactive'}`}
